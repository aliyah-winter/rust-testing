fn main() {
  ...
  println!("{}", shark(24.0, 0.0, 4.0, 8.0, true));
...
fn shark(pontoon_distance: f64, shark_distance: f64, you_speed: f64, shark_speed: f64, dolphin: bool) -> String {
  ...
  match pontoon_distance / you_speed < shark_distance / (if dolphin { shark_speed / 2.0 } else {shark_speed}) {
    true => String::from("Alive!"),
    false => String::from("Shark Bait!")
  }
}